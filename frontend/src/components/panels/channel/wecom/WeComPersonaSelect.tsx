/**
 * Persona preset selector for WeCom channel configuration.
 * WeCom channels can bind a persona so messages from that channel use the same role.
 */
import {
  useCallback,
  useEffect,
...
interface WeComPersonaSelectProps {
...
export function WeComPersonaSelect({
  value,
  onChange,
}: WeComPersonaSelectProps) {
  ...
  return (
    <div className="es-field">
      ...
      <p className="es-hint">
        {t("wecom.personaHint", "选择这个渠道收到消息时使用的角色预设。")}
      </p>
    </div>
  );
}
