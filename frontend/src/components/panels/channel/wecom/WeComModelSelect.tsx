/**
 * Model selector for WeCom channel configuration.
...
interface WeComModelSelectProps {
  value: string | null | undefined;
  onChange: (modelId: string | null) => void;
}

export function WeComModelSelect({
  value,
  onChange,
}: WeComModelSelectProps) {
      ...
      <GlassSelect
        ...
        placeholder={
          loading
            ...
            : t("wecom.defaultModel", "Default Model")
        }
